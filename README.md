...
- `vector`: float32 vector encoding, dimension validation, exact cosine search, optional turbovec-backed search for dimensions divisible by 8, top-k helpers, and reciprocal-rank fusion.
